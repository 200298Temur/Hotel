...
import com.hotel.hotelapplication.exception.PhotoRetrivalException;
...
import com.hotel.hotelapplication.service.BookingService;
...
public class RoomController {
    ...
    public ResponseEntity<RoomResponse> addNewRoom(
        ...
        log.info("sorov keldi 1 --->");

        Room savedRoom = roomService.addNewRoom(photo, roomType, roomPrice);
        RoomResponse response = new RoomResponse(savedRoom.getId(), savedRoom.getRoomType(),
                savedRoom.getRoomPrice());
        log.info("sorov keldi 2 --->");
    ...
    public ResponseEntity<List<RoomResponse>>  getAllRooms() throws SQLException {
        ...
        for(Room room:rooms){
            byte[] photoBytes=roomService.gedtRoomPhotoByRoomId(room.getId());
